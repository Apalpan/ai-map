    ...
    <div className="absolute top-0 left-0 right-0 z-50 flex h-14 items-center justify-between border-b border-[var(--color-brand-border)]/70 bg-[var(--brand-surface)]/70 px-3 shadow-sm backdrop-blur-md transition-all sm:px-4">
      ...
      <div className="flex min-w-0 flex-1 justify-end">
        ...
        <button
          ...
          title="Cerrar sesión"
          className="ml-1 flex h-11 w-11 shrink-0 items-center justify-center rounded-[var(--radius-md)] text-[var(--brand-secondary)] transition-[background-color,color,transform] duration-150 hover:bg-[var(--action-soft)] hover:text-[var(--action)] active:scale-[0.97] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--focus)]"
        >
          {isLoggingOut ? (
